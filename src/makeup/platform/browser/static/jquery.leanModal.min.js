...
// Validates that the input string is a valid date formatted as "yyyy-mm-dd"  mm/dd/yyy
  ...
  for(var i in events){
    var mua_date = events[i]["Date"].toISOString().slice(0,10).replace(/-/g,"");
    var mua_hour = events[i]["Title"].substring(0,5);
...
//    {'Date': new Date(2017, 6, 7), 'Title': '18:00-19:00 - Popescu Ionela'},
