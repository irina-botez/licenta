...
// Validates that the input string is a valid date formatted as "yyyy-mm-dd"  mm/dd/yyy
  ...
  var all_events = localStorage.getItem("doc_json_string");
  ...
  book_event = {'Date': new Date(year, month-1, day), 'Title': res_hour+' - Makeup appointment'};
  ...
  localStorage.setItem("doc_json_string", all_events);
...
//  $('.eventday').each(function(index){
//    if($('.cld-title').length>1){
//      var child = $("span.cld-title a")[1]; alert(child.text());
//      $("span.cld-title")[0].append(child);
//      $("span.cld-title")[1].remove();
//    }
//  })
  };
